...
func (h *handler) CreateProduct(w http.ResponseWriter, r *http.Request) {
  ...
  if err != nil {
    ...
    slog.Error(fmt.Sprintf("error to create category: %v", err), slog.String("package", "producthandler"))
    w.WriteHeader(http.StatusBadRequest)
  }
...
func (h *handler) DeleteProduct(w http.ResponseWriter, r *http.Request) {
  ...
  if err != nil {
    ...
    slog.Error(fmt.Sprintf("error to delete category: %v", err), slog.String("package", "producthandler"))
    w.WriteHeader(http.StatusBadRequest)
  }
